...
@section('content')
    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">• {{ $date->day }} {{ $date->translatedFormat('F') }}, {{ $date->year }} •
                {{ $date->format('H:i') }} • {{ $post->comments->count() }} комментария</p>
            <section class="blog-post-featured-img" data-aos="fade-up" data-aos-delay="300">
                <img src="{{ asset(Storage::url($post->main_image)) }}" alt="featured image" class="w-100">
            </section>
            ...
            <section class="related-posts">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                        <img src="{{ asset(Storage::url($relatedPost->preview_image)) }}" alt="related post" class="post-thumbnail">
                ...
                <form action="{{ route('post.comment.store', $post->id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-12" data-aos="fade-up">
                            ...
                            <textarea name="message" id="message" class="form-control" placeholder="Написать комментарий" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="row">
